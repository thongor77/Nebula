...
- Toute valeur visuelle (couleur, police, espacement, durée d'animation)
  est lue depuis `ThemeConfig`, jamais codée en dur.
...
- **Fournit** : avatar, nom d'affichage, navigation clavier, état focus
  accessible.
...
| Sélecteur d'utilisateur            | `NebulaUserList`              |
...
- [ ] Zéro warning QML
- [ ] Toutes les valeurs visuelles passent par `ThemeConfig`
